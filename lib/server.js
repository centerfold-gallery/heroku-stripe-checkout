...
function sendEmail(err, logFields, options) {
  let subject = (err ? 'Stripe failure' : 'Zephyr registration successful!');
  ...
  text += "We'll be in touch with you soon to welcome you to Zephyr. If you have any questions, just email us at membership@zephyrtransport.org.\n\n";
  ...
  html += "<br><p>We'll be in touch with you soon to welcome you to Zephyr. If you have any questions, just email us at membership@zephyrtransport.org.</p>\n";
